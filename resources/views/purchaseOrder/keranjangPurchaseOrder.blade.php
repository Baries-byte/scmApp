<x-layoutAdmin>
    ...
    <div class="mx-5 mt-5 border-4 p-4 mb-10 md:mx-10">
                            ...
                            @foreach ($barangSupplier as $b)
                                <tr>
                                    ...
                                    <td class="border border-slate-600 p-1 text-center">
                                        <form action="{{ route('storeDetailPurchaseOrder') }}" method="POST">
                                            @csrf
                        ...
                        @foreach ($detailPurchaseOrder as $po)
                            <tr>
                                ...
                                <td class="border border-slate-600 p-1 w-1/4">
                                    <div class="flex">
                                        <form action="{{ route('updataDetailPurchaseOrder') }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <form method="POST"
                                            action="{{ route('deleteDetailPurchaseOrder', ['detailPurchaseOrder' => $po->id]) }}"
                                            class="mx-1">
                                            @csrf
                                            @method('DELETE')
                                            <button>
        ...
        <div class="w-full flex justify-end my-2">
            <a href="{{ route('teruskanKePemilik', ['purchaseOrder' => $purchaseOrder->id]) }}"
